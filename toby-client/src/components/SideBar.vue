<template>
    ...
    <div class="py-[16px] col-span-1 columns-sm content-between grid border-x border-y border-rgbgray  h-screen bg-primary">
        ...
        <div class="font-light">
            ...
            <div class=" flex justify-center items-center flex-col text-sm cursor-pointer my-4 hover:text-pink-500 pr-1 opacity-50">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="chakra-icon css-q2fpm4 size-8" focusable="false"><path d="M10 5a2 2 0 1 1 4 0a7 7 0 0 1 4 6v3a4 4 0 0 0 2 3h-16a4 4 0 0 0 2 -3v-3a7 7 0 0 1 4 -6"></path><path d="M9 17v1a3 3 0 0 0 6 0v-1"></path></svg>
                <p>Updates</p>
            </div>            
            <div class=" flex justify-center items-center flex-col text-sm cursor-pointer my-4 hover:text-pink-500 pr-1">
