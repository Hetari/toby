    ...
    <div class="col-span-4 grid  bg-primary content-between border-y border-rgbgray">
        <div class="flex flex-col w-full">
            ...
            <div class="flex justify-between w-full pt-4 px-2 pb-4 pr-4">
                <a class="text-2xl pl-2 font-medium cursor-pointer" :click="goToUserInfo()">Ammar</a>
                <button class="hover:text-pink-500">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="chakra-icon css-e13ry2" focusable="false"><path d="M4 4m0 2a2 2 0 0 1 2 -2h12a2 2 0 0 1 2 2v12a2 2 0 0 1 -2 2h-12a2 2 0 0 1 -2 -2z"></path><path d="M9 4v16"></path><path d="M15 10l-2 2l2 2"></path></svg>
                </button>
            </div>

            <div class="flex space-x-2 border-t border-b border-rgbgray p-6  hover:text-pink-500 cursor-pointer">
            ...
            <div class="grid border-b border-rgbgray p-4 text-xl">
                ...
                <div class="flex space-x-3 pb-2 font-light hover:text-pink-500 cursor-pointer">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="chakra-icon css-1pipko8" focusable="false"><path d="M14 2a5 5 0 0 1 5 5v14a1 1 0 0 1 -1.555 .832l-5.445 -3.63l-5.444 3.63a1 1 0 0 1 -1.55 -.72l-.006 -.112v-14a5 5 0 0 1 5 -5h4z" fill="currentColor" stroke-width="0"></path></svg>
                    <p class="opacity-90">Next</p>
                </div>
         ...
         <div class="pt-4 p-2">
            <p class="text-xl pl-3 pt-2 pb-6 font-medium">Spaces</p>
            
            <div class="flex space-x-2 pl-2 pb-6 text-xl font-light hover:text-pink-500 cursor-pointer">
                ...
                <p class="opacity-90">Starred Collections</p>
            </div>
            <div class="flex space-x-2 pl-2 text-xl font-light hover:text-pink-500 cursor-pointer">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="chakra-icon css-1uje9ol" focusable="false"><path d="M5 13a2 2 0 0 1 2 -2h10a2 2 0 0 1 2 2v6a2 2 0 0 1 -2 2h-10a2 2 0 0 1 -2 -2v-6z"></path><path d="M11 16a1 1 0 1 0 2 0a1 1 0 0 0 -2 0"></path><path d="M8 11v-4a4 4 0 1 1 8 0v4"></path></svg>
                <p class="opacity-90">My Collections</p>
            </div>
         </div>
        </div>

        <div class="pb-4 pt-3 pl-1 border-t border-rgbgray font-light">
            <div class="flex space-x-2 pt-2 p-2 hover:text-pink-500 opacity-90 cursor-pointer">
            ...
            <div class="flex space-x-2 p-2 hover:text-pink-500 opacity-90 cursor-pointer">
