    ...
    <div  class="col-span-2 grid  bg-primary content-between border-r-1 border-l-1 border-b-1">
        <div class="flex flex-col w-full">
            ...
            <div class="grid border-b-1 p-4 text-xl">
                ...
                <div class="flex space-x-3 pb-2 font-light hover:text-pink-500">
         ...
         <div class="pt-4 p-2">
            ...
            <div class="flex space-x-2 pl-2 pb-6 text-xl font-light hover:text-pink-500">
            ...
            <div class="flex space-x-2 pl-2 text-xl font-light hover:text-pink-500">
        ...
        <div class="pb-4 pt-3 pl-1 border-t-1 font-light">
            ...
            <div class="flex space-x-2 p-2 hover:text-pink-500 opacity-90">
